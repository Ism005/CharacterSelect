...
import oroart from '../../img/oro-portrait.webp';
import yunyangart from '../../img/yun_yang-portrait.webp';
import necroart from '../../img/necro-portrait.webp';
...
const data = [
    ...
    {name: 'Ken', img: kenart, desc: "Après s'être rangé dans la vie de couple pendant quelques années, Ken s'est inscrit au troisième tournoi de Street Fighter. C'est un artiste martial américain qui s'entraîne pour suivre son vieil ami/rival Ryu.\n" +
            "\n" +
    ...
    {name: 'Yun & Yang', img: yunyangart , desc: ''},
    {name: 'Necro', img: necroart, desc: ''},
    {name: 'Oro', img: oroart, desc: ''},
]
